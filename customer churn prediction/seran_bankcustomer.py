...
data = pd.read_csv(r"C:\Users\seran\Downloads\archive (1)\Churn_Modelling.csv")
...
X_train, X_test, y_train, y_test = train_test_split(X_scaled, y, test_size=0.75, random_state=42, stratify=y)
