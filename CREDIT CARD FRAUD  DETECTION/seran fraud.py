...
# Load the dataset
df = pd.read_csv(r"C:\Users\seran\Downloads\archive (3)\fraudTrain.csv")
...
df = df.drop(['Unnamed: 0', 'trans_date_trans_time', 'cc_num', 'first', 'last', 'street', 'city', 'state', 'zip', 'lat', 'long', 'dob', 'unix_time', 'trans_num'], axis=1)
...
plt.figure(figsize=(8, 6))
sns.countplot(x=y, color='purple')  # Changed 'palette' to 'color'
...
plt.figure(figsize=(8, 6))
sns.countplot(x=y_train_res, color='purple')  # Changed 'palette' to 'color'
